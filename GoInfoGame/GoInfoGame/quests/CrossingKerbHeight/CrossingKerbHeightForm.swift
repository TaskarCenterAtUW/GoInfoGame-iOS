...
struct CrossingKerbHeightForm: View, QuestForm {
    ...
    let imageData: [ImageData] = [
        ...
        ImageData(id:"kerb_height_lowered_ramp",type: "lowered", imageName: "kerb_height_lowered_ramp", tag: "lowered", optionName: LocalizedStrings.questKerbHeightLoweredRamp.localized),
    ...
    var body: some View {
        VStack (alignment: .leading){
            ...
            VStack(alignment: .leading){
                ...
                ImageGridItemView(gridCount: 2, isLabelBelow: false, imageData: imageData, isImageRotated: false, isDisplayImageOnly: false, isScrollable: true, allowMultipleSelection: false, onTap: { (selectedImage) in
