//
//  HasDateTagLessOrEqualThanTest.swift
//  QParserTests
//
...
final class HasDateTagLessOrEqualThanTest: XCTestCase {
    ...
    func testMatches() throws {
        ...
        let c = HasDateTagLessOrEqualThan(key: "check_date", dateFilter: FixedDate(theDate: date))
        
        XCTAssertFalse(c.matches(tags: [:]))
        XCTAssertFalse(c.matches(tags: ["check_date": "bla"]))
        XCTAssertFalse(c.matches(tags: ["check_date": "2000-11-12"]))
        XCTAssertTrue(c.matches(tags: ["check_date": "2000-11-11"]))
        XCTAssertTrue(c.matches(tags: ["check_date": "2000-11-10"]))
    }
